    ...
    <>
      ...
      <section className="min-h-screen bg-gray-50">
        ...
        <div className="flex flex-col lg:flex-row">
          {/* Filter Sidebar */}
          <aside className="w-full lg:w-1/5 bg-[#fdfbf6] p-4 lg:p-6 border-b lg:border-b-0 lg:border-r border-gray-200">
            <h2 className="text-lg font-semibold mb-4 text-gray-800">
              Filters
            </h2>

            {/* Mobile: Horizontal layout, Desktop: Vertical layout */}
            <div className="flex flex-row lg:flex-col gap-4 lg:gap-0 lg:space-y-4">
